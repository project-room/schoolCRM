$(function () {
    ...
    $('.recycle .operate').find('.delete').click(function () {
        ...
        // $('#recyclecover .smallModal_content').html('<p style=" margin-top: 60px;text-align: center;font-size: 20px;">文件删除后无法恢复，是否确定删除所选文件？</p><div style=" margin-top: 50px;text-align: center;"><input type="button" value="取消"><input type="button" value="确定" style="background: skyblue;"></div>')
        // $('#recyclecover .smallModal_content').find('input').css('width', 100).css('height', 40).css('border-radius', 10).css('border', 'none').css('margin', '0 15px 0 15px')
        // $('#recyclecover .smallModal_content').find('input').click(function (event) {
        //     if ($(this).val() == "取消") {
        //         event.stopPropagation();
        //         // smallshowHide();
        //     } else {
    ...
    $('.registrationInformationTitle .registrationLeft input[value="导出"]').click(function () {
        $('#registrationexportcover').show();
        $('#registrationexportmodal').show()
    })
    $('#registrationexportclose').click(function(){
        $('#registrationexportcover').hide();
        $('#registrationexportmodal').hide()
    })
    $('#registrationexportmodal .modal_button input[value="取消"]').click(function () {
        $('#registrationexportcover').hide();
        $('#registrationexportmodal').hide()
    })
