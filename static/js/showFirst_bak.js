$(function () {
    ...
    for (var k = 0; k < backgroundList.length; k++) {
        ...
        $(backgroundList[0]).click(function () {
            ...
            $(this).css('background', "url('/static/img/class.png') 20px center no-repeat").find('a').css('color', '#fcb636');
        })
        $(backgroundList[1]).click(function () {
            background();
            $('.sideContent .studentBig').css('display', 'block');
            $(this).css('background', "url('/static/img/student.png') 20px center no-repeat").find('a').css('color', '#fcb636');
        })
        $(backgroundList[2]).click(function () {
            background();
            $('.sideContent .teacherNew').css('display', 'block');
            $(this).css('background', "url('/static/img/teacher.png') 20px center no-repeat").find('a').css('color', '#fcb636');
        })
        $(backgroundList[3]).click(function () {
            background();
            $('.sideContent .numberSetting').css('display', 'block');
            $(this).css('background', "url('/static/img/setting.png') 20px center no-repeat").find('a').css('color', '#fcb636');
        })
        $(backgroundList[4]).click(function () {
            background();
            $('.sideContent .recycle').css('display', 'block');
            $(this).css('background', "url('static/img/huishou.png') 20px center no-repeat").find('a').css('color', '#fcb636');
        })
    }

    function background() {
        $(backgroundList[0]).css('background', "url('/static/img/class01.png') 20px center no-repeat").find('a').css('color', '#808080');
        $(backgroundList[1]).css('background', "url('/static/img/student01.png') 20px center no-repeat").find('a').css('color', '#808080');
        $(backgroundList[2]).css('background', "url('/static/img/teacher01.png') 20px center no-repeat").find('a').css('color', '#808080');
        $(backgroundList[3]).css('background', "url('/static/img/setting01.png') 20px center no-repeat").find('a').css('color', '#808080');
        $(backgroundList[4]).css('background', "url('/static/img/huishou01.png') 20px center no-repeat").find('a').css('color', '#808080');
    ...
    /**开始就展示 */
    $('.sideContent .tiaoshi').css('display', 'block');
    // $(backgroundList[0]).css('background', "url('../static/img/class.png') 20px center no-repeat").find('a').css('color', '#fcb636');
    ...
    $('.recycle .operate').find('.comeback').click(function () {
        // console.log(123)
        $('.smallModal_content').html('<p style=" margin-top: 60px;text-align: center;font-size: 20px;">确定还原所选文件?</p><div style=" margin-top: 50px;text-align: center;"><input type="button" value="取消"><input type="button" id="recycle_redo_link" value="确定" style="background: skyblue;"></div>')
    ...
    $('.recycle .re_button').find('input[value="还原"]').click(function () {
        ...
        $('.smallModal_content').html('<p style=" margin-top: 60px;text-align: center;font-size: 20px;">确定还原所选文件?</p><div style=" margin-top: 50px;text-align: center;"><input type="button" value="取消"><input type="button" id="recycle_redo" value="确定" style="background: skyblue;"></div>')
        $('.smallModal_content').find('input').css('width', 100).css('height', 40).css('border-radius', 10).css('border', 'none').css('margin', '0 15px 0 15px')
        $('.smallModal_content').find('input[value="取消"]').click(function (event) {
            event.stopPropagation();
            smallshowHide();
    ...
    $('.recycle .operate').find('.delete').click(function () {
        $('.smallModal_content').html('<p style=" margin-top: 60px;text-align: center;font-size: 20px;">文件删除后无法恢复，是否确定删除所选文件？</p><div style=" margin-top: 50px;text-align: center;"><input type="button" value="取消"><input type="button" value="确定" id="delete_forever_link" style="background: skyblue;"></div>')
        $('.smallModal_content').find('input').css('width', 100).css('height', 40).css('border-radius', 10).css('border', 'none').css('margin', '0 15px 0 15px')
    ...
    $('.recycle .re_button').find('input[value="删除"]').click(function () {
        $('.smallModal_content').html('<p style=" margin-top: 60px;text-align: center;font-size: 20px;">文件删除后无法恢复，是否确定删除所选文件？</p><div style=" margin-top: 50px;text-align: center;"><input type="button" value="取消"><input type="button" id="delete_forever" value="确定" style="background: skyblue;"></div>')
        $('.smallModal_content').find('input').css('width', 100).css('height', 40).css('border-radius', 10).css('border', 'none').css('margin', '0 15px 0 15px')
        $('.smallModal_content').find('input').click(function (event) {
            if ($(this).val() == "取消") {
                event.stopPropagation();
    ...
    $('.sideContent .studentDetail .editAll').click(function () {
        location.href = "/student"
    })
    ...
    //  }
    /**点击图片返回 */
    $('.sideContent .teacherNew .teacherDetailTitle .editAll').click(function () {
        location.href = "/teacher"
    })
...
$('.teacherDetail .detailContent .classTitle .all').click(function(e){
    ...
    //    location.href="./setting_add.html"
    // });
    // $('.settingNumber .settingTitle').find('input[value="编辑"]').click(function () {
    //     location.href="./setting_edit.html"
    // $('#settingcover').show();
    // $('#settingmodal').show()
    ...
    $('.editNumber .edit .editAll').click(function () {
        location.href = "/operators/settings"
    })
